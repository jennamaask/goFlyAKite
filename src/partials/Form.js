      ...
      <div className="intakeForm" id="intakeForm">
        ...
        <form action="submit" onSubmit={this.handleSubmit}>
          ...
          <select
            ...
            required
          >
            <option className="description" value="" disabled>
              Where did you Kiteboard?
            </option>
          ...
          <fieldset>
            ...
            <div className="fieldsetContainer">
              ...
              <input
                ...
                id="mediumLight"
                onChange={this.handleChange}
                checked={this.state.wind === "mediumLight"}
                required
              />
              <label htmlFor="mediumLight">
                On the lighter side (13-17 knots)
              </label>
              <input
                type="radio"
                name="wind"
                ...
                id="mediumStrong"
                onChange={this.handleChange}
                checked={this.state.wind === "mediumStrong"}
                required
              />
              ...
              <input
                ...
                id="strong"
                onChange={this.handleChange}
                checked={this.state.wind === "strong"}
                required
              />
          ...
          <fieldset>
            ...
            <div className="fieldsetContainer">
              ...
              <input
                ...
                id="mostFun"
                onChange={this.handleChange}
                checked={this.state.fun === "mostFun"}
                required
              />
