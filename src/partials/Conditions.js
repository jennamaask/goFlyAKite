        ...
        >
          <div className="wrapper">
            ...
            {this.state.submissions.map(submission => {
              const convertedLocation = submission.location.replace(
                /([A-Z])/g,
                " $1"
              );
              let displayLocation =
                convertedLocation.charAt(0).toUpperCase() +
                convertedLocation.slice(1);
              return (
                <div className="entry">
                  ...
                  <p className="displayWind">
                    {windDescription[submission.wind]}
                  </p>
                  <p className="displayWave">
                    {waveDescription[submission.waves]}
                  </p>
